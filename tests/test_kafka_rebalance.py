...
from lib.rebalance import __version__ as rebalance_ver
from lib.connections import __version__ as connection_ver


def test_version():
    assert rebalance_ver == '0.1.1'
    assert connection_ver == '0.1.1'
